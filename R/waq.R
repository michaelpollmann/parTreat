...
#' @return list of two elements: \item{tau}{the point estimate of the treatment effect} \item{se}{the estimated standard error}
#' @examples
...
#' waq(X,Y)
#' @export
waq <- function(X,Y,xf=NULL,d2_logf=NULL,...) {
